...
import '../../core/constants/somaliland_cities.dart';
...
class _CreateListingPageState extends State<CreateListingPage> {
  ...
  String _selectedCondition = 'used'; // Default restored since we added 'used' to dropdown items
  ...
  void _initializeForm() {
    if (widget.listing != null) {
      ...
      _selectedCity = SomalilandCities.getDefaultCity();
      final defaultCoords = SomalilandCities.getDefaultCoordinates();
      _selectedLocation = LatLng(defaultCoords['lat']!, defaultCoords['lng']!);
    }
  }
  ...
  Future<void> _saveListing() async {
    ...
    try {
      ...
      final cityCoords = SomalilandCities.getCityCoordinates(_selectedCity!) ??
          SomalilandCities.getDefaultCoordinates();

      // Use map location if set, otherwise use city coordinates
      final finalLocation = _selectedLocation ?? LatLng(cityCoords['lat']!, cityCoords['lng']!);
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            onChanged: (value) {
              setState(() {
                _selectedCondition = value ?? 'used'; // Default restored since we added 'used' to dropdown items
              });
            },
          ),
        ],
        ...
        children: [
          ...
          DropdownButtonFormField<CategoryItem>(
            ...
            onChanged: (value) {
              ...
              print('Category selected: ${value?.name}'); // Debug line
            },
            validator: (value) {
              if (value == null) {
          ...
          if (_subcategories.isNotEmpty) ...[
            ...
            DropdownButtonFormField<String>(
              ...
              onChanged: (value) {
                ...
                print('Subcategory selected: $value'); // Debug line
              },
              validator: (value) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // City dropdown
          DropdownButtonFormField<String>(
            value: _selectedCity != null && SomalilandCities.getCityNames().contains(_selectedCity) 
                ? _selectedCity 
                : null,
            decoration: InputDecoration(
              labelText: 'City *',
            ...
            isExpanded: true,
            items: SomalilandCities.getCityNames().map((city) {
              return DropdownMenuItem<String>(
                value: city,
                child: Text(city),
              );
            ...
            onChanged: (value) {
              setState(() {
                _selectedCity = value;
                // Update map location to city coordinates
                if (value != null) {
                  final coords = SomalilandCities.getCityCoordinates(value);
                  if (coords != null) {
                    _selectedLocation = LatLng(coords['lat']!, coords['lng']!);
                  }
                }
              });
            },
